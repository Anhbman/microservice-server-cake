...
func (x *SearchCake) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SearchCake) ProtoMessage() {}

func (x *SearchCake) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_service_cake_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SearchCake.ProtoReflect.Descriptor instead.
func (*SearchCake) Descriptor() ([]byte, []int) {
	return file_rpc_service_cake_proto_rawDescGZIP(), []int{1}
}

func (x *SearchCake) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *SearchCake) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *SearchCake) GetDescription() string {
	if x != nil {
...
func (x *SearchCake) GetPrice() int64 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *SearchCake) GetImageUrl() string {
	if x != nil {
		return x.ImageUrl
	}
	return ""
...
func (x *SearchCake) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
type SearchCakeResponse struct {
	...
	Cakes []*SearchCake `protobuf:"bytes,1,rep,name=cakes,proto3" json:"cakes,omitempty"`
}
...
func (x *SearchCakeResponse) GetCakes() []*SearchCake {
	if x != nil {
		return x.Cakes
	}
	return nil
...
var file_rpc_service_cake_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x9e, 0x01, 0x0a, 0x0a, 0x53, 0x65, 0x61,
	0x72, 0x63, 0x68, 0x43, 0x61, 0x6b, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	...
	0x04, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x43, 0x0a, 0x12, 0x53, 0x65, 0x61,
	0x72, 0x63, 0x68, 0x43, 0x61, 0x6b, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x2d, 0x0a, 0x05, 0x63, 0x61, 0x6b, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17,
	0x2e, 0x72, 0x70, 0x63, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x53, 0x65, 0x61,
	0x72, 0x63, 0x68, 0x43, 0x61, 0x6b, 0x65, 0x52, 0x05, 0x63, 0x61, 0x6b, 0x65, 0x73, 0x22, 0x95,
	0x01, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x61, 0x6b, 0x65, 0x52, 0x65, 0x71,
	...
	0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x24, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x43, 0x61, 0x6b,
	0x65, 0x42, 0x79, 0x49, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0xa7, 0x01, 0x0a,
	0x13, 0x47, 0x65, 0x74, 0x43, 0x61, 0x6b, 0x65, 0x42, 0x79, 0x49, 0x64, 0x52, 0x65, 0x73, 0x70,
	...
	0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x42, 0x0e, 0x5a, 0x0c, 0x2f, 0x72, 0x70, 0x63, 0x2f, 0x73,
...
var file_rpc_service_cake_proto_goTypes = []any{
	...
	(*SearchCake)(nil),          // 1: rpc.service.SearchCake
...
var file_rpc_service_cake_proto_depIdxs = []int32{
	1, // 0: rpc.service.SearchCakeResponse.cakes:type_name -> rpc.service.SearchCake
...
func file_rpc_service_cake_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rpc_service_cake_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_rpc_service_cake_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*SearchCake); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rpc_service_cake_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_rpc_service_cake_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_rpc_service_cake_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_rpc_service_cake_proto_msgTypes[5].Exporter = func(v any, i int) any {
